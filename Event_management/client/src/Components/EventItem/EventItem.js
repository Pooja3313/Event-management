      ...
      >
        ...
        <DialogContent>
          <DialogContentText sx={{ textAlign: 'center' }}>
            <Typography sx={{ mb: 2, fontSize: '1.1rem' }}>Date: {event.date}</Typography>
            <Typography sx={{ mb: 2, fontSize: '1.1rem' }}>Location: {event.location}</Typography>
            <Typography sx={{ mb: 2, color: isUpcoming ? 'green' : 'red', fontWeight: 'bold' }}>
              Status: {status}
            </Typography>
          </DialogContentText>
        </DialogContent>
